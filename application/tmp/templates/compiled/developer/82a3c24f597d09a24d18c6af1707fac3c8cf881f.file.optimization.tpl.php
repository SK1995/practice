<?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 05:43:39
         compiled from "/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/utils/optimization.tpl" */ ?>
<?php /*%%SmartyHeaderCode:78475869057c795db037d77-23639048%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '82a3c24f597d09a24d18c6af1707fac3c8cf881f' => 
    array (
      0 => '/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/utils/optimization.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '78475869057c795db037d77-23639048',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c795db184480_10437824',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c795db184480_10437824')) {function content_57c795db184480_10437824($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/home/you/php/practice/framework/classes/modules/viewer/plugs/function.router.php';
...
<?php if ($_smarty_tpl->tpl_vars['sMenuItemSelect']->value=='profile'){?>itemscope itemtype="http://data-vocabulary.org/Person"<?php }?>>
    ...
    <h2 class="page-header"><span><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['datareset']['title'];?>
</span></h2>

    <div class="mb-20">
        <?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['datareset']['info'];?>

    </div>

    <div class="mb-10">
        <a href="<?php echo smarty_function_router(array('page'=>'admin/utils/optimization/resetallbansstats'),$_smarty_tpl);?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
                ><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['datareset']['resetallbansstats'];?>
</a>
    </div>

    <div class="mb-10">
        <a href="<?php echo smarty_function_router(array('page'=>'admin/utils/optimization/deleteoldbanrecords'),$_smarty_tpl);?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
                ><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['datareset']['deleteoldbanrecords'];?>
</a>
    </div>

    <div class="mb-10">
        <a href="<?php echo smarty_function_router(array('page'=>'admin/utils/optimization/resetalllscache'),$_smarty_tpl);?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
                ><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['datareset']['resetalllscache'];?>
</a>
    </div>
	...
	<h2 class="page-header"><span><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['tables']['title'];?>
</span></h2>

	<div class="mb-20">
		<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['tables']['info'];?>

	</div>

	<div class="mb-10">
		<a href="<?php echo smarty_function_router(array('page'=>'admin/utils/optimization/repaircomments'),$_smarty_tpl);?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
				><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['tables']['repair_comments'];?>
</a>
	</div>

	<div class="mb-10">
		<a href="<?php echo smarty_function_router(array('page'=>'admin/utils/optimization/cleanstream'),$_smarty_tpl);?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
				><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['tables']['clean_stream'];?>
</a>
	</div>

	<div class="mb-10">
		<a href="<?php echo smarty_function_router(array('page'=>'admin/utils/optimization/cleanvotings'),$_smarty_tpl);?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
				><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['tables']['clean_votings'];?>
</a>
	</div>

	<div class="mb-10">
		<a href="<?php echo smarty_function_router(array('page'=>'admin/utils/optimization/cleanfavourites'),$_smarty_tpl);?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
				><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['tables']['clean_favourites'];?>
</a>
	</div>
	...
	<h2 class="page-header mt-30"><span><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['files']['title'];?>
</span></h2>

	<div class="mb-20">
		<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['files']['info'];?>

	</div>

	<div class="mb-10">
		<a href="<?php echo smarty_function_router(array('page'=>'admin/utils/optimization/checkencoding'),$_smarty_tpl);?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
				><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['optimization']['files']['check_encoding'];?>
</a>
	</div>
