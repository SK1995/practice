<?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 06:46:32
         compiled from "/home/you/php/practice/application/frontend/components/activity/event.tpl" */ ?>
<?php /*%%SmartyHeaderCode:209971761157c7a498236ca9-73103393%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc38896e8a77544beedda383985c4b4f6133000a' => 
    array (
      0 => '/home/you/php/practice/application/frontend/components/activity/event.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '209971761157c7a498236ca9-73103393',
  'function' => 
  array (
    'activity_event_text' => 
    array (
  ...
  'unifunc' => 'content_57c7a49832e153_95586440',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c7a49832e153_95586440')) {function content_57c7a49832e153_95586440($_smarty_tpl) {?><?php if (!is_callable('smarty_function_date_format')) include '/home/you/php/practice/framework/classes/modules/viewer/plugs/function.date_format.php';
...
<?php $_smarty_tpl->tpl_vars['event'] = new Smarty_variable((isset($_smarty_tpl->tpl_vars_local['event']) ? $_smarty_tpl->tpl_vars_local['event']->value : null), null, 0);?>
...
-text text"><?php echo $_smarty_tpl->tpl_vars['text']->value;?>
</div>
    <?php }?>
...
<?php $_tmp7=ob_get_clean();?><?php echo smarty_function_lang(array('_default_short'=>"activity.events.".((string)$_smarty_tpl->tpl_vars['type']->value)."_".((string)$_smarty_tpl->tpl_vars['gender']->value),'blog'=>"<a href=\"".((string)$_smarty_tpl->tpl_vars['target']->value->getUrlFull())."\">".$_tmp7."</a>"),$_smarty_tpl);?>
    ...
    <?php }elseif($_smarty_tpl->tpl_vars['type']->value=='add_wall'){?>
        
        <?php if ($_smarty_tpl->tpl_vars['target']->value->getWallUser()->getId()==$_smarty_tpl->tpl_vars['user']->value->getId()){?>
            <?php echo smarty_function_lang(array('_default_short'=>"activity.events.".((string)$_smarty_tpl->tpl_vars['type']->value)."_self_".((string)$_smarty_tpl->tpl_vars['gender']->value),'url'=>$_smarty_tpl->tpl_vars['target']->value->getUrlWall()),$_smarty_tpl);?>

        <?php }else{ ?>
            <?php echo smarty_function_lang(array('_default_short'=>"activity.events.".((string)$_smarty_tpl->tpl_vars['type']->value)."_".((string)$_smarty_tpl->tpl_vars['gender']->value),'url'=>$_smarty_tpl->tpl_vars['target']->value->getUrlWall(),'user'=>$_smarty_tpl->tpl_vars['target']->value->getWallUser()->getDisplayName()),$_smarty_tpl);?>
...
<?php $_tmp8=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'item','element'=>'li','classes'=>((string)$_smarty_tpl->tpl_vars['component']->value)." ".$_tmp8,'mods'=>'image-rounded','desc'=>Smarty::$_smarty_vars['capture']['event_content'],'image'=>array('url'=>$_smarty_tpl->tpl_vars['user']->value->getUserWebPath(),'path'=>$_smarty_tpl->tpl_vars['user']->value->getProfileAvatarPath(48),'alt'=>$_smarty_tpl->tpl_vars['user']->value->getDisplayName())),$_smarty_tpl);?>
<?php }} ?>