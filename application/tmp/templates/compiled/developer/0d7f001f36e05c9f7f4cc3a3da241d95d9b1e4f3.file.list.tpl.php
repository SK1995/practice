<?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 05:39:58
         compiled from "/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/skins/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:55484573757c794fe118225-85953308%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0d7f001f36e05c9f7f4cc3a3da241d95d9b1e4f3' => 
    array (
      0 => '/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/skins/list.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '55484573757c794fe118225-85953308',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c794fe230de2_08456095',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c794fe230de2_08456095')) {function content_57c794fe230de2_08456095($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/home/you/php/practice/framework/classes/modules/viewer/plugs/function.router.php';
...
<?php if ($_smarty_tpl->tpl_vars['sMenuItemSelect']->value=='profile'){?>itemscope itemtype="http://data-vocabulary.org/Person"<?php }?>>
	...
	<h2 class="page-sub-header"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['settings']['titles']['current_skin'];?>
</h2>
	
	<div class="skin-list">
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."actions/ActionAdmin/skins/skin.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('oSkin'=>$_smarty_tpl->tpl_vars['oSkinCurrent']->value), 0);?>

	</div>
	
	<h2 class="page-sub-header"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['settings']['titles']['skin_config'];?>
</h2>

	<div class="skin-list">
		<?php  $_smarty_tpl->tpl_vars['oSkin'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['oSkin']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['aSkins']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['oSkin']->key => $_smarty_tpl->tpl_vars['oSkin']->value){
$_smarty_tpl->tpl_vars['oSkin']->_loop = true;
?>
			<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."actions/ActionAdmin/skins/skin.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
