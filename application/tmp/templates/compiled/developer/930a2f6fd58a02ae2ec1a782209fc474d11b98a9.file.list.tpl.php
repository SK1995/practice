<?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 06:37:22
         compiled from "/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/utils/cron/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:160346944057c7a272c417e8-41790737%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '930a2f6fd58a02ae2ec1a782209fc474d11b98a9' => 
    array (
      0 => '/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/utils/cron/list.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
    ...
    '44d507ad65df56da41c666fc49d6f0806ca1bdf0' => 
    array (
      0 => '/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/utils/cron/item.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '160346944057c7a272c417e8-41790737',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c7a272d74802_14767375',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c7a272d74802_14767375')) {function content_57c7a272d74802_14767375($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/home/you/php/practice/framework/classes/modules/viewer/plugs/function.router.php';
...
<div class="actionbar  clearfix">
	...
	<a href="<?php echo smarty_function_router(array('page'=>"admin/utils/cron/create"),$_smarty_tpl);?>
" class="button button-primary"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['add'];?>
</a>
	...
	<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['utils']['cron']['title'];?>
	...
	<div class="mb-20">
		<?php echo smarty_function_lang(array('name'=>'plugin.admin.utils.cron.instruction','path'=>$_smarty_tpl->tpl_vars['sPathCron']->value),$_smarty_tpl);?>

	</div>

	<?php if ($_smarty_tpl->tpl_vars['aTaskItems']->value){?>
		<table class="table">
			<thead>
			<tr>
				<th>Название</th>
			...
			<tbody>
			<?php  $_smarty_tpl->tpl_vars['oTaskItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['oTaskItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['aTaskItems']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['oTaskItem']->key => $_smarty_tpl->tpl_vars['oTaskItem']->value){
$_smarty_tpl->tpl_vars['oTaskItem']->_loop = true;
?>
				<?php /*  Call merged included template "./item.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('./item.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('oTaskItem'=>$_smarty_tpl->tpl_vars['oTaskItem']->value), 0, '160346944057c7a272c417e8-41790737');
content_57c7a272d2f703_94588962($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "./item.tpl" */?>
			<?php } ?>
			</tbody>
		</table>
	<?php }else{ ?>
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."alert.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('mAlerts'=>"Список задач пуст",'sAlertStyle'=>'empty'), 0);?>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 06:37:22
         compiled from "/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/utils/cron/item.tpl" */ ?>
<?php if ($_valid && !is_callable('content_57c7a272d2f703_94588962')) {function content_57c7a272d2f703_94588962($_smarty_tpl) {?><?php if (!is_callable('smarty_function_date_format')) include '/home/you/php/practice/framework/classes/modules/viewer/plugs/function.date_format.php';
...
?><tr id="cron-item-<?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getId();?>
">
	<td>
		<?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getTitleWithLang();?>
<br/>
		<?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getMethod();?>

	</td>
	<td><?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getPlugin();?>
</td>
	<td><?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getPeriodRun();?>
</td>
	<td><?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getCountRun();?>
</td>
	<td><?php echo smarty_function_date_format(array('date'=>$_smarty_tpl->tpl_vars['oTaskItem']->value->getDateRunLast(),'format'=>'j F Y <\b\r/> H:i:s'),$_smarty_tpl);?>
</td>
	<td>
		<?php if ($_smarty_tpl->tpl_vars['oTaskItem']->value->getState()==ModuleCron::TASK_STATE_ACTIVE){?>
			да
		<?php }else{ ?>
			нет
		<?php }?>
	...
	<td class="ta-r">
		<a href="#" class="icon-play" title="Запустить сейчас" onclick="return ls.admin_cron.runTask(<?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getId();?>
);"></a>
		<a href="<?php echo smarty_function_router(array('page'=>'admin/utils/cron/update'),$_smarty_tpl);?>
<?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getId();?>
/" class="icon-edit" title="Изменить"></a>
		<a href="<?php echo smarty_function_router(array('page'=>'admin/utils/cron/remove'),$_smarty_tpl);?>
<?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getId();?>
/?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
" class="icon-remove" title="Удалить" onclick="if (confirm('Действительно удалить?')) { ls.plugin.article.admin.removeArticle(<?php echo $_smarty_tpl->tpl_vars['oTaskItem']->value->getId();?>
); } return false;"></a>
	</td>
</tr><?php }} ?>