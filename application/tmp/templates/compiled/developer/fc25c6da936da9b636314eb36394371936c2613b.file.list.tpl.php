<?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 05:40:45
         compiled from "/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/property/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:35124021957c7952dcb6b21-52025824%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc25c6da936da9b636314eb36394371936c2613b' => 
    array (
      0 => '/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/property/list.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '35124021957c7952dcb6b21-52025824',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c7952ddf4518_04766177',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c7952ddf4518_04766177')) {function content_57c7952ddf4518_04766177($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/home/you/php/practice/framework/classes/modules/viewer/plugs/function.router.php';
...
<div class="actionbar  clearfix">
	...
	<a href="<?php echo smarty_function_router(array('page'=>"admin/properties/".((string)$_smarty_tpl->tpl_vars['sPropertyTargetType']->value)."/create"),$_smarty_tpl);?>
" class="button button-primary"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['add'];?>
						...
						<div class="content-padding">
								...
								<h2 class="page-header">Список полей типа &laquo;<?php echo $_smarty_tpl->tpl_vars['aPropertyTargetParams']->value['name'];?>
&raquo;</h2>
	...
	<?php if ($_smarty_tpl->tpl_vars['aPropertyItems']->value){?>
		<script>
			jQuery(function($){
		...
		<table class="table" id="property-list">
            ...
            <tbody>
				<?php  $_smarty_tpl->tpl_vars['oPropertyItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['oPropertyItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['aPropertyItems']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['oPropertyItem']->key => $_smarty_tpl->tpl_vars['oPropertyItem']->value){
$_smarty_tpl->tpl_vars['oPropertyItem']->_loop = true;
?>
					<tr data-id="<?php echo $_smarty_tpl->tpl_vars['oPropertyItem']->value->getId();?>
">
						<td><?php echo $_smarty_tpl->tpl_vars['oPropertyItem']->value->getTitle();?>
</td>
						<td><?php echo $_smarty_tpl->tpl_vars['oPropertyItem']->value->getCode();?>
</td>
						<td><?php echo $_smarty_tpl->tpl_vars['oPropertyItem']->value->getType();?>
</td>
						<td class="ta-r">
							<a href="<?php echo $_smarty_tpl->tpl_vars['oPropertyItem']->value->getUrlAdminUpdate();?>
" class="icon-edit" title="<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['edit'];?>
"></a>
							<a href="<?php echo $_smarty_tpl->tpl_vars['oPropertyItem']->value->getUrlAdminRemove();?>
...
"
	...
	<?php }else{ ?>
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."alert.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('sAlertStyle'=>'info','mAlerts'=>'Нет дополнительных полей'), 0);?>
