<?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 05:42:15
         compiled from "/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/property/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:150188060757c79587ddebb7-12340319%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c259dbad200c66edfdcaf8dc40ee6e0b93bce20' => 
    array (
      0 => '/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/property/update.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '150188060757c79587ddebb7-12340319',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c79587f1dd83_79562095',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c79587f1dd83_79562095')) {function content_57c79587f1dd83_79562095($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/home/you/php/practice/framework/classes/modules/viewer/plugs/function.router.php';
...
" class="button">&larr; Назад к списку полей</a>
						...
						<div class="content-padding">
								...
								<h2 class="page-header">Редактирование поля для типа &laquo;<?php echo $_smarty_tpl->tpl_vars['aPropertyTargetParams']->value['name'];?>
&raquo;</h2>
	...
	<form method="post">
		...
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."forms/fields/form.field.select.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('sFieldName'=>'property[type]','sFieldLabel'=>'Тип поля','sFieldClasses'=>'width-200','aFieldItems'=>$_smarty_tpl->tpl_vars['aPropertyType']->value,'bFieldIsDisabled'=>true,'sFieldSelectedValue'=>$_smarty_tpl->tpl_vars['oProperty']->value->getTypeTitle()), 0);?>


		
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."forms/fields/form.field.text.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('sFieldName'=>'property[title]','sFieldValue'=>$_smarty_tpl->tpl_vars['oProperty']->value->getTitle(),'sFieldLabel'=>'Название'), 0);?>


		
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."forms/fields/form.field.text.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('sFieldName'=>'property[description]','sFieldValue'=>$_smarty_tpl->tpl_vars['oProperty']->value->getDescription(),'sFieldLabel'=>'Краткое описание'), 0);?>


		
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."forms/fields/form.field.text.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('sFieldName'=>'property[code]','sFieldValue'=>$_smarty_tpl->tpl_vars['oProperty']->value->getCode(),'sFieldLabel'=>'Код'), 0);?>

		
		
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."actions/ActionAdmin/property/types/type.".((string)$_smarty_tpl->tpl_vars['oProperty']->value->getType()).".tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('oPropertyValidateRules'=>$_smarty_tpl->tpl_vars['oProperty']->value->getValidateRulesEscape(),'oPropertyParams'=>$_smarty_tpl->tpl_vars['oProperty']->value->getParamsEscape()), 0);?>


		
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."forms/fields/form.field.button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('sFieldName'=>'property_update_submit','sFieldText'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['save'],'sFieldValue'=>'1','sFieldStyle'=>'primary'), 0);?>
