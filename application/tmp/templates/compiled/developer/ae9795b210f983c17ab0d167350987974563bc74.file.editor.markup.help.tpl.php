<?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 05:41:06
         compiled from "/home/you/php/practice/framework/frontend/components/editor/editor.markup.help.tpl" */ ?>
<?php /*%%SmartyHeaderCode:206077382357c79542966c06-14646484%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae9795b210f983c17ab0d167350987974563bc74' => 
    array (
      0 => '/home/you/php/practice/framework/frontend/components/editor/editor.markup.help.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '206077382357c79542966c06-14646484',
  'function' => 
  array (
    'editor_help_item' => 
    array (
  ...
  'unifunc' => 'content_57c79542a08f07_88114955',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c79542a08f07_88114955')) {function content_57c79542a08f07_88114955($_smarty_tpl) {?>
...
?><dl class="editor-help-item"><?php  $_smarty_tpl->tpl_vars['aTag'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['aTag']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['aItem']->value['tags']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['aTag']->key => $_smarty_tpl->tpl_vars['aTag']->value){
$_smarty_tpl->tpl_vars['aTag']->_loop = true;
?><dt><a href="#" class="link-dotted js-tags-help-link" <?php if ($_smarty_tpl->tpl_vars['aTag']->value['insert']){?>data-insert="<?php echo $_smarty_tpl->tpl_vars['aTag']->value['insert'];?>
"<?php }?>><?php echo $_smarty_tpl->tpl_vars['aTag']->value['text'];?>
</a></dt><?php } ?><dd><?php echo $_smarty_tpl->tpl_vars['aItem']->value['def'];?>
</dd></dl><?php } ?>
...
<div class="editor-help js-editor-help" data-form-id="<?php echo (isset($_smarty_tpl->tpl_vars_local['targetId']) ? $_smarty_tpl->tpl_vars_local['targetId']->value : null);?>
">
	<header class="editor-help-header clearfix">
		<a href="#" class="link-dotted help-link js-editor-help-toggle"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['editor']['markup']['help']['link_show'];?>
</a>
	</header>
