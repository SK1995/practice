<?php /* Smarty version Smarty-3.1.13, created on 2016-09-01 05:41:57
         compiled from "/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/category/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:23511851857c795757a9935-63107788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ccebac9ef9413f8b682010bacf1bcc9a8e735454' => 
    array (
      0 => '/home/you/php/practice/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/category/list.tpl',
      1 => 1472657853,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '23511851857c795757a9935-63107788',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c795758c33c5_39970822',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c795758c33c5_39970822')) {function content_57c795758c33c5_39970822($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/home/you/php/practice/framework/classes/modules/viewer/plugs/function.router.php';
...
<div class="actionbar  clearfix">
	...
	<a href="<?php echo smarty_function_router(array('page'=>"admin/categories/".((string)$_smarty_tpl->tpl_vars['oCategoryType']->value->getTargetType())."/create"),$_smarty_tpl);?>
" class="button button-primary"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['add'];?>
						...
						<div class="content-padding">
								...
								<h2 class="page-header">Категории типа &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oCategoryType']->value->getTitle(), ENT_QUOTES, 'UTF-8', true);?>
&raquo;</h2>
	...
	<?php if ($_smarty_tpl->tpl_vars['aCategoryItems']->value){?>
		<table class="table">
            <thead>
				<tr>
					<th>Название</th>
            ...
            <tbody>
				<?php  $_smarty_tpl->tpl_vars['aCategoryItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['aCategoryItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['aCategoryItems']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['aCategoryItem']->key => $_smarty_tpl->tpl_vars['aCategoryItem']->value){
$_smarty_tpl->tpl_vars['aCategoryItem']->_loop = true;
?>
					<?php $_smarty_tpl->tpl_vars['oCategoryItem'] = new Smarty_variable($_smarty_tpl->tpl_vars['aCategoryItem']->value['entity'], null, 0);?>
					<?php $_smarty_tpl->tpl_vars['iLevel'] = new Smarty_variable($_smarty_tpl->tpl_vars['aCategoryItem']->value['level'], null, 0);?>
					<tr data-id="<?php echo $_smarty_tpl->tpl_vars['oCategoryItem']->value->getId();?>
">
						<td>
							<i class="icon-file" style="margin-left: <?php echo $_smarty_tpl->tpl_vars['iLevel']->value*20;?>
px;"></i>
							<?php if ($_smarty_tpl->tpl_vars['oCategoryItem']->value->getWebUrl()){?>
								<a href="<?php echo $_smarty_tpl->tpl_vars['oCategoryItem']->value->getWebUrl();?>
" border="0"><?php echo $_smarty_tpl->tpl_vars['oCategoryItem']->value->getTitle();?>
</a>
							<?php }else{ ?>
								<?php echo $_smarty_tpl->tpl_vars['oCategoryItem']->value->getTitle();?>

							<?php }?>
						</td>
						<td><?php echo $_smarty_tpl->tpl_vars['oCategoryItem']->value->getUrlFull();?>
</td>
						<td><?php echo $_smarty_tpl->tpl_vars['oCategoryItem']->value->getCountTargetOfDescendants();?>
</td>
						<td class="ta-r">
							<a href="<?php echo $_smarty_tpl->tpl_vars['oCategoryItem']->value->getUrlAdminUpdate();?>
" class="icon-edit" title="<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['edit'];?>
"></a>
							<a href="<?php echo $_smarty_tpl->tpl_vars['oCategoryItem']->value->getUrlAdminRemove();?>
?security_ls_key=<?php echo $_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value;?>
"
							   class="icon-remove js-question"
							   title="<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['delete'];?>
"
	...
	<?php }else{ ?>
		<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['aTemplatePathPlugin']->value['admin'])."alert.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('sAlertStyle'=>'info','mAlerts'=>'Нет категорий. Вы можете добавить новую.'), 0);?>
