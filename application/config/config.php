 ...
 * Настройка каптчи
 */
$config['sys']['captcha']['type'] = 'recaptcha'; // тип используемой каптчи: kcaptcha, recaptcha
/**
...
$config['module']['user']['complaint_captcha'] = false;  // Использовать или нет каптчу при написании жалобы
